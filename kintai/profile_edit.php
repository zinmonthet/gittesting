				...
				<form action="#" method="post" id="register-form" novalidate="novalidate">
					<?php foreach ($profile_data as $query_data) { ?>
						<table class="tbl_form">
                            ...
                            <tr>
                                <td class="right" width="50%">社員ID</td>
                                <td>
							...
							<tr>
								...
								<td>
									<input type="password" id="old_pass" name="old_pass" width=''
									       ...
									       ?>" disabled>
									<br>
									<input type="password" name='new_pass' placeholder=' Type new password'
									       id="new_pass">
								</td>
							</tr>
							<tr>
								<td class="center" colspan="2">
									<input type="submit" value="保存する" name='profile_edit' class="button">
								</td>
							</tr>
						</table>
					<?php } ?>
